...
extern double Tstar2 = 9.0; // T* required for the quench
...
extern int nquench = 10000000; // No. Time iterations for quench
...
extern int tener = 1; //Output frequency for energy file
extern int tscr = 10; //Output frequency for screen printing
extern int top = 1; //Output frequency for order parameter analysis in the heating phase
#endif
